...
namespace VideoRental.API.Migrations
{
    public partial class Seed : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Videos",
                columns: new[] { "Id", "Genre", "MaximumAge", "Title", "VideoTypeId", "Years" },
                values: new object[,]
                {
                    { 1, "Drama", 0, "Diary of a Chambermaid", 1, 0 },
                    { 28, "Horror", 0, "The Feathered Serpent", 3, 1 },
                    { 27, "Action", 0, "Red Hook Summer", 3, 1 },
                    { 26, "Drama", 0, "As Long as You've Got Your Health (Tant qu'on a la santé)", 3, 2 },
                    { 25, "Romance", 0, "Time of Eve (Eve no jikan)", 3, 2020 },
                    { 24, "Comedy", 0, "Big Tease, The", 3, 1 },
                    { 23, "Comedy", 0, "Sorority Babes in the Slimeball Bowl-O-Rama", 3, 1 },
                    { 22, "Comedy", 0, "Singing Detective, The", 3, 2 },
                    { 21, "Horror", 0, "YellowBrickRoad", 3, 2 },
                    ...
                    { 29, "Comedy", 0, "Little Lili (La petite Lili)", 3, 2 },
                    { 30, "Romance", 0, "Falling in Love", 3, 1 }
                });
